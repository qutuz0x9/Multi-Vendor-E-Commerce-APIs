...
public class GetMyCartItemsTest
{
    ...
    [Fact]
    public async Task GetMyCartItemsAsync_WhenUserIsNotCustomer_ShouldReturnForbidden()
    {
        // ── 1) ARRANGE ────────────────────────────────────────────────────────────
    ...
    [Fact]
    public async Task GetMyCartItemsAsync_WhenCartSessionNotFound_ShouldReturnNotFound()
    {
        // ── 1) ARRANGE ────────────────────────────────────────────────────────────
        var userId = Guid.NewGuid();
    ...
    [Fact]
    public async Task GetMyCartItemsAsync_WhenCartSessionExists_ShouldReturnItems()
    {
        // ── 1) ARRANGE ────────────────────────────────────────────────────────────
        var userId = Guid.NewGuid();
        var customerId = Guid.NewGuid();
        ...
        _cartItemRepositoryMock
            ...
            .ReturnsAsync(new List<CartItem>
            {
                ...
                new() { Id = 2, VendorOfferId = 3, Quantity = 1, CartSessionId = cartSessionId }
            });
