...
public class VendorConfigurations : IEntityTypeConfiguration<Vendor>
{
    public void Configure(EntityTypeBuilder<Vendor> builder)
    {
        ...
        builder.Property(v => v.ModifiedAt).HasColumnName("ModifiedAt");
        builder.Property(v => v.IsDeleted).HasColumnName("IsDeleted").HasDefaultValue(false);
        builder.Property(v => v.DeletedAt).HasColumnName("DeletedAt");
        builder.Property(v => v.AverageRate).HasColumnName("AverageRate").HasColumnType("decimal(3,2)");
        builder.Property(v => v.TotalReviews).HasColumnName("TotalReviews").HasDefaultValue(0);

        // Indexes
        builder.HasIndex(v => v.Slug).IsUnique().HasDatabaseName("IX_Vendor_Slug");
